...
- **Tuesday** &rarr; 7:00PM EST - 10:00PM EST </li>
- **Thursday** &rarr; 7:00PM EST - 10:00PM EST</li>
...
<details> <summary>Live Share Extension Pack</summary>
...
<details> <summary>Prettier</summary>
...
<details> <summary>Numbered Bookmarks</summary>

- Description: Mark lines and jump to them, in Delphi style
- Publisher: Alessandro Fragnani
- [VS Marketplace Link](https://marketplace.visualstudio.com/items?itemName=alefragnani.numbered-bookmarks)

</details>

<details> <summary>GitLens</summary>
...
<details> <summary>GitHub Pull Requests and Issues</summary>
...
<details> <summary>Console Ninja</summary>
...
- [tldr pages](https://tldr.sh/): The tldr pages are a community effort to simplify the beloved man pages with practical examples.
- [Starship](https://starship.rs/): Minimal, blazing-fast, and infinitely customizable prompt for any shell
- [NerdFonts](https://www.nerdfonts.com/): patches developer targeted fonts with a high number of glyphs (icons). Specifically to add a high number of extra glyphs from popular ‘iconic fonts’ such as Font Awesome, Devicons, Octicons, and others.
...
#### Foundations: A Playlist

- [:tv:](https://www.youtube.com/playlist?list=PLuncerFeaBtMKo0HUj3qZLtMU-uMppgbm)
  This playlist covers EVERYTHING in unit 1 + 2 and more advanced concepts we haven't touched on. It may be helpful during the course (there's videos on all kinds of topics), but these will be incredibly helpful toward the end of the course as you prepare for interviews. You'll need to have a solid understanding of JS and computer science concepts and foundations - which this will help with! -->
...
- [Big O Notation in 5 minutes](https://www.youtube.com/watch?v=__vX2sjlpXU): Guide to understanding time and space complexity
- [BigO Cheatsheet](https://www.bigocheatsheet.com/): Great reference/resource for built-in JS methods.

##### Sorting

- [Sorting Algorithm Animations](https://www.toptal.com/developers/sorting-algorithms): Helpful tool to see animations of different sorting algos
- [Sorting Algorithm Cheatsheet](https://www.interviewcake.com/sorting-algorithm-cheat-sheet): Quick and easy reference for common sorting algos
- [Playlist- Sorting Algorithms Visualizations](https://www.youtube.com/watch?v=aXXWXz5rF64&list=PL2aHrV9pFqNS79ZKnGLw-RG5gH01bcjRZ): Like the above animation, but versus! Little robots compete against each other using different sorting algos.

#### Further Investigation

##### Prototype Chain

- [Inheritance and the prototype chain](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Inheritance_and_the_prototype_chain): Walkthrough of foundational JS concept: the prototype chain!

##### Object-Oriented Programming

- [Introduction of Object Oriented Programming](https://www.geeksforgeeks.org/introduction-of-object-oriented-programming/): Solid and thorough introduction to OOP concepts with practical examples.
- [How to explain object-oriented programming concepts to a 6-year-old](https://www.freecodecamp.org/news/object-oriented-programming-concepts-21bb035f7260/): High-level overview of OOP concepts.
- [The Principles of Object-Oriented JavaScript](http://www.r-5.org/files/books/computers/languages/escss/fp/Nicholas_C_Zakas-The_Principles_of_JavaScript-EN.pdf): PDF of book on OOP.

##### Functional Programming

- [Understanding JavaScript Currying](https://blog.logrocket.com/understanding-javascript-currying/): Exampls and clear explanation of an unclear subject.
- [Professor Frisby's Mostly Adequate Guide to Functional Programming](https://mostly-adequate.gitbook.io/mostly-adequate-guide/): As advertised!
- [Functional Programming in JavaScript](https://www.manning.com/books/functional-programming-in-javascript): Link contains pdf of the book as well as a link to purchase. -->

<!-- ##### Node

- [JavaScript Modules](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules): My least favorite bug to solve. This is a good guide on how to properly structure your project.
- [package.json](https://docs.npmjs.com/cli/v10/configuring-npm/package-json): You know it, you love it, but what is it? Guide to `package.json`.
- [npm](https://docs.npmjs.com/cli/v10/commands/npm): What the heck do these letters mean? Documentation for Node Package Manager (NPM). -->

<!-- ##### React Context API

- [How to Use React Context API in Your Projects](https://www.freecodecamp.org/news/context-api-in-react/): React Context provides a lightweight and easy-to-use alternative to Redux. For small to medium apps, most use Context instead of Redux.
- [Cart Functionality in React with Context API](https://dev.to/anne46/cart-functionality-in-react-with-context-api-2k2f): Very helpful and detailed tutorial of building an e-commerce app using the Context API. -->

---

<!-- ### Not Internet Resources (AKA Books)

- [Eloquent JavaScript](https://eloquentjavascript.net/): Good all-around reference for JavaScript langaues and concepts. Completely free online, but it's also a book.
  - [Book](https://nostarch.com/ejs3)
  - [PDF](https://eloquentjavascript.net/Eloquent_JavaScript.pdf)
- [A Smarter Way to Learn Javascript](https://www.asmarterwaytolearn.com/): Highly recommended resource for reading and practicing as you go.
  - [Book](https://www.amazon.com/Smarter-Way-Learn-JavaScript-technology-ebook/dp/B00H1W9I6C?ref_=ast_author_dp&dib=eyJ2IjoiMSJ9.6-Y531J3KKMFkj9RMQ1iS1ij2EmpGaz0zMiCKiEK0WHO4J479aOp4_PpfbdsPbc4yGx7xWQgxmv7jWS72ZPHDbxEPsB1GplPhs9xDHfo9rc.nwbLe7NCfjifkz1aUOimxp0dtPtcEa9lWFE5eWc05e0&dib_tag=AUTHOR)
  - [PDF](https://wccftech.com/wp-content/uploads/2014/10/JavaScript.pdf)
- [Cracking the Coding Interview](https://www.crackingthecodinginterview.com/): A classic, must-have resource for preparing for interviews. -->
